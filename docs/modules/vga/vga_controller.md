...
| `ARST_SYS_P`      | std_logic    |    in     | -             | Input system clock domain asynchronous reset, active high                                              |
...
| `ARST_VGA_P`      | std_logic    |    in     | -             | Input VGA clock domain asynchronous reset, active high                                                 |
