...
![SPI timing diagram for CPOL=0, CPHA=0](../_static/svg/UART-SPI-MASTER-CPOL0-CPHA0.svg)
...
![SPI timing diagram for CPOL=0, CPHA=1](../_static/svg/UART-SPI-MASTER-CPOL0-CPHA1.svg)
...
![SPI timing diagram for CPOL=1, CPHA=0](../_static/svg/UART-SPI-MASTER-CPOL1-CPHA0.svg)
...
![SPI timing diagram for CPOL=1, CPHA=1](../_static/svg/UART-SPI-MASTER-CPOL1-CPHA1.svg)
...
![SPI Master FSM](../_static/svg/UART-SPI-MASTER-FSM.svg)
