...
- [**NVC**](https://github.com/nickg/nvc/releases/tag/r1.22.0): `Version r1.22.0`
- **Vivado**: `Version 2025.2`

Also tested with:

- [**NVC**](https://github.com/nickg/nvc/releases): `Version r1.18.2`, `Version r1.19.3` and `Version r1.20.1`, `r1.21.1`
